class Currencies {
  ...
  //Return a list of currencies which will be offered to the user
  async getCurrencies(currenciesToList) {

    //These are all currencies originally returned by the API and permanently cached
    let allCurrencies = {
...
/*This is a request to get life currencies from the server - It can be used if needed, however, 
the list of currencies is permanently cached because the selected subset is expected to remain stable.*/
